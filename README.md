...
* [**Download macOS App v7.0.5 (Apple Silicon / M1/M2/M3)**](https://github.com/MichaelBrandonFalk/iconik-locator/releases/latest/download/Iconik_Locator_App_v7_0_5_arm64.zip)
...
The browser version can be blocked by Iconik/browser CORS rules even when credentials are valid. Use the local macOS app for reliable lookups and bulk work.
